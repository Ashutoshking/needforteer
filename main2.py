...
oot_channel_id_list = ["628291818257121298",
"588070986554015764",
"626992737018970112"
...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        # embed creation
        self.embed=discord.Embed(title= "__**Confeeti India**__", description="***Searching Answer***..........", color=0x00ffff)
...
def selfbot_process(update_event, answer_scores):
    ...
    loop = asyncio.get_event_loop()
    loop.create_task(selfbot.start('NTk4NTQ0MjUyMzcyMzg1Nzk5.XYesHg.Qzp0YGY-4r5SP_3WfbeLRRc3jtQ',
                                   bot=False))
    loop.run_forever()
