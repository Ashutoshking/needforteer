...
oot_channel_id_list = ["613744392968208403"
...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        # embed creation
        self.embed=discord.Embed(title="", description="**__Searching Answer__**....")
        ...
        self.embed.add_field(name="**SUGGESTED ANSWER!**{best_answer}", value="0", inline=True,color=00bfff)
 ...
 best_answer = ":regional_indicator_b:"
            ...
            if answer == 3:
                three_check = ":one::white_check_mark:"
 best_answer = ":regional_indicator_c:"
        ...
        self.embed.set_field_at(3, name="SUGGESTED ANSWER!**{best_answer}", value=best_answer, inline=True)
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.Activity(type=1,name='with Confetti India🇮🇳!'))
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NjE3MjIzMzUyOTMwNTMzMzg3.XWoqrQ.FT1W2F3VZpJMkQLMwLiFt8P-Ysc'))
    loop.run_forever()
